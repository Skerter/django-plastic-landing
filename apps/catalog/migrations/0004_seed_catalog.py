...
CATEGORIES = [{'name': 'Канистры', 'slug': 'kanistry', 'order': 1, 'is_active': True},
 {'name': 'Крышки', 'slug': 'kryshki', 'order': 2, 'is_active': True}]

PRODUCTS = [{'category_slug': 'kanistry',
  ...
  'is_active': True,
  'order': 0,
  'specs': [{'label': 'Объём', 'value': '1', 'unit': 'л', 'order': 0},
 ...
 {'category_slug': 'kanistry',
  ...
  'is_active': True,
  'order': 2,
  'specs': [{'label': 'Объём', 'value': '5', 'unit': 'л', 'order': 0},
 ...
 {'category_slug': 'kanistry',
  ...
  'is_active': True,
  'order': 3,
  'specs': [{'label': 'Объём', 'value': '10', 'unit': 'л', 'order': 0},
 ...
 {'category_slug': 'kanistry',
  ...
  'is_active': True,
  'order': 4,
  'specs': [{'label': 'Объём', 'value': '20', 'unit': 'л', 'order': 0},
 ...
 {'category_slug': 'kanistry',
  ...
  'is_active': True,
  'order': 5,
  'specs': [{'label': 'Объём', 'value': '30', 'unit': 'л', 'order': 0},
 ...
 {'category_slug': 'kryshki',
  ...
  'is_active': True,
  'order': 0,
  'specs': [{'label': 'Диаметр', 'value': '45', 'unit': 'мм', 'order': 0},
            {'label': 'Совместимость', 'value': 'канистры 1, 5, 10 л', 'unit': '', 'order': 1}]},
 {'category_slug': 'kryshki',
  'name': 'Крышка 55 мм',
  'slug': 'kryshka-55',
  'badge': 'Крышка',
  ...
  'is_active': True,
  'order': 1,
  'specs': [{'label': 'Диаметр', 'value': '55', 'unit': 'мм', 'order': 0},
            {'label': 'Совместимость', 'value': 'канистры 20, 30 л', 'unit': '', 'order': 1}]},
 {'category_slug': 'kryshki',
  ...
  'is_active': True,
  'order': 2,
  'specs': [{'label': 'Высота', 'value': '9', 'unit': 'мм', 'order': 0},
...
def seed(apps, schema_editor):
    ...
    for c in CATEGORIES:
        obj, _ = Category.objects.update_or_create(
            slug=c['slug'],
            defaults={'name': c['name'], 'order': c['order'], 'is_active': c['is_active']},
        )
