...
def _event_with_pii():
    ...
    return {
        'request': {
            ...
            'method': 'POST',
            'data': {'name': 'Иван', 'phone': '+74950000000', 'email': 'ivan@example.com'},
        ...
        'exception': {
            'values': [{
                'type': 'ValueError',
                'value': 'boom',
                'stacktrace': {'frames': [{'filename': 'apps/leads/views.py', 'lineno': 42}]},
            }],
        },
            ...
            'values': [{
                ...
                'stacktrace': {
                    'frames': [{
                        ...
                        'function': 'level_1',
                        'vars': {
                            'payload': {'name': 'Иван Тестов', 'phone': '+74950000000'},
                            'price': '1000',
                        },
                    }],
                },
